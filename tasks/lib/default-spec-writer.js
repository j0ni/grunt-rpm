...
module.exports = function(options, callback) {
  ...
  // FIXME the following macro definition should not be needed if the
  // --define command line parameter is taken into account by rpmbuild
  ...
  src += formatField('License', optionalValue(options.license, 'UNKNOWN'));
